...
const AllProduct = () => {
    ...
    const fetching = async () => {
      try {
        const resp = await fetch(
          "https://phone-specs-g57ftrc7l-azharimms-projects.vercel.app/brands/samsung-phones-9",
          { signal: abortCards.signal }
        );
  ...
  const openCard = (slug) => {
    ...
    const getDetails = async () => {
      ...
      try {
        const resp = await fetch(
          `https://phone-specs-g57ftrc7l-azharimms-projects.vercel.app/${slug}`,
  ...
  return (
    <div className="loading-notfound">
      ...
      <main className="all-product">
        ...
        <DetailsCard
          phone_name={detailsData.phone_name}
          dimension={detailsData.dimension}
          release_date={detailsData.dimension}
          os={detailsData.os}
          storage={detailsData.storage}
