    ...
    const fetchData = async () => {
      try {
        const resp = await fetch(
          `https://phone-specs-g57ftrc7l-azharimms-projects.vercel.app/${type}`,
          { signal: abortMoreDetails.signal }
        );
        ...
        <main className="details-table">
          <div className="image-product-details-table">
            {imageProduct ? (
              ...
              <div className="loading-image-MoreDetails"></div>
            )}
          </div>
          ...
          {nameProduct ? (
            ...
            <h1 className="loading-MoreDetails">Loading...</h1>
          )}
